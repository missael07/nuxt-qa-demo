...
const _routes = [
  ...
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-D--IHC5l.js")
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-BCrKz7-B.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-geKXBx4m.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DIwtR79T.js"));
